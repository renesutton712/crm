    ...
    $(function () {
        ...
        $.each(availableFromPlaces, function (index, val) {
            ...
            $(nextBtn).on('click', function (e) {
                ...
                let form = $(this).parent().parent(),
                    ...
                    step2 = $(form).find('.step-2'),
                    email = $(form).find('.email').val();
                if (!validateFirstStep($(form), fn, ln, email)) {
                    return
                }
                $(step1).slideUp();
                $(step2).slideDown();
        ...
        function formElements() {
            ...
            let form = "<form id='user-form-lp'>" +
                "<div class='step-1'>" +
                "<div class='fn-holder'>" + fn + "</div>" + "<div class='ln-holder'>" + ln + "</div>" +
                "<div class='email-input'><div>" + email + "</div>" + "</div>" +
                "<div class='password-input'><div>" + password + "</div>" + "</div>" +
                "<button id='next' type='btn'>Next</button> " +
                "</div>" +
                "<div class='step-2'>" +
        ...
        function validateFirstStep(form, fn, ln, email) {

...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/lib/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/apps/chat/Chat.vue?vue&type=style&index=0&lang=scss&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/lib??ref--8-2!./node_modules/sass-loader/dist/cjs.js??ref--8-3!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/apps/chat/Chat.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  sendChatMessage: function sendChatMessage(_ref4, payload) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/apps/chat/msg', {
        payload: payload
  ...
  fetchContacts: function fetchContacts(_ref5) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/apps/chat/contacts', {
        params: {
          q: ''
        }
      }).then(function (response) {
  ...
  fetchChatContacts: function fetchChatContacts(_ref6) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/apps/chat/chat-contacts', {
        params: {
          q: ''
        }
      }).then(function (response) {
  ...
  fetchChats: function fetchChats(_ref7) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/apps/chat/chats').then(function (response) {
  ...
  markSeenAllMessages: function markSeenAllMessages(_ref8, id) {
    var getters = _ref8.getters,
        commit = _ref8.commit;
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/apps/chat/mark-all-seen', {
        id: id
      }).then(function (response) {
  ...
  toggleIsPinned: function toggleIsPinned(_ref9, payload) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/apps/chat/set-pinned/', {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  chatDataOfUser: function chatDataOfUser(state) {
    return function (id) {
      return state.chats[_babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(state.chats).find(function (key) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  SEND_CHAT_MESSAGE: function SEND_CHAT_MESSAGE(state, payload) {
    if (payload.chatData) {
      ...
      state.chats[_babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(state.chats).find(function (key) {
        return Number(key) === payload.id;
      })].msg.push(payload.msg);
    } else {
      // Create New chat and add msg
      var chatId = payload.id;
      vue__WEBPACK_IMPORTED_MODULE_1___default.a.set(state.chats, [chatId], {
